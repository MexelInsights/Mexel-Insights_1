/**
 * MEXEL INSIGHTS — Backend API Server
...
// ── SYSTEM PROMPT ─────────────────────────────────────────
const MEXEL_SYSTEM_PROMPT = `You are the lead intelligence analyst at Mexel Insights — an independent geopolitical intelligence firm specialising in energy transition, critical minerals, regulatory pressure, and geopolitical risk.
...
- Framework: Every output follows Context → Signals → Moves → Uncertainty Flags
...
3. PPI (Policy Pressure Index): Sector × Jurisdiction scoring (0-5)
...
Score each dimension 0.0–5.0 based on current regulatory environment.
Return ONLY valid JSON:
{
  "sector": "${sector}",
  "jurisdiction": "${jurisdiction}",
